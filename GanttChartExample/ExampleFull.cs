...
namespace Braincase.GanttChart
{
    ...
    public partial class ExampleFull : Form
    {
        ...
        private void _InitExampleUI()
        {
            ...
            //TaskGridView.Columns.Add(new BoundField { DataField = "a" });
            TaskGridView.DataSource = new BindingSource(_mManager.Tasks, null);
            //TaskGridView.Columns[_mManager.Tasks.].DisplayIndex = 0;
    ...
    {/*
        ...
        /// <param name="e"></param>
        public void (object sender, ChartPaintEventArgs e)
        {
    ...
    */
    ...
    public class MyTask : Task
    {
        ...
        private BM_Project Project { get; set; }

        public string Start2
        {
            get { return Manager.GetDateTime(base.Start).ToString("yyyy-MM-dd"); }
            set
            {
                Manager.SetStart(this, DateTime.Parse(value) - Manager.GetStartDate());
            }
        }
        public string End2
        {
            get { return Manager.GetDateTime(base.End - TimeSpan.FromDays(1)).ToString("yyyy-MM-dd"); }
            set
            {
                Manager.SetEnd(this, (DateTime.Parse(value) - Manager.GetStartDate()) + TimeSpan.FromDays(1)); ;
            }
        }
        public new float Complete { get { return base.Complete * 100; } set { Manager.SetComplete(this, value); } }
        ...
        public new TimeSpan Duration { get { return base.End - base.Start; } set { Manager.SetDuration(this, DateTime.Parse(base.End2) - DateTime.Parse(base.Start2) + TimeSpan.FromDays(1)); } }
    }
}
